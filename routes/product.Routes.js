...
router
  ...
  .put(adminGuard, prodRules.updateProductValidator, ProdServ.updateSpecificProduct)
  .delete(adminGuard, prodRules.getSpecificProduct, ProdServ.deleteSpecificProduct);
